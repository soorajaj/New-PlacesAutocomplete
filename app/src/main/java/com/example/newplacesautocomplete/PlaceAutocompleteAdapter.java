...
///**
// * Adapter that handles Autocomplete requests from the Places Data Client.
...
//    private AutocompleteFilter mPlaceFilter;
    ...
    FindAutocompletePredictionsRequest mrequest;
    Context mcontext;
    AutocompleteSessionToken mtoken;
    ArrayList<AutocompletePrediction> requestTask;
...
//     * @see AutocompletePrediction#freeze()
    ...
    private ArrayList<AutocompletePrediction> getAutocomplete(CharSequence constraint) {
        Log.i("place", "Starting autocomplete query for: " + constraint);

        FindAutocompletePredictionsRequest request = FindAutocompletePredictionsRequest.builder()
                // Call either setLocationBias() OR setLocationRestriction().
//                .setLocationBias(mBounds)
                // if you need to restrict the location search to a particular area, set the mBounds value to latlong of the area
//                .setLocationRestriction(mBounds)
        ...
        mplacesClient.findAutocompletePredictions(request).addOnSuccessListener(new OnSuccessListener<FindAutocompletePredictionsResponse>() {
            ...
            public void onSuccess(FindAutocompletePredictionsResponse response) {
                ...
                try {
                    requestTask=new ArrayList<AutocompletePrediction>(autocompletePredictions);
                }catch (Exception e){
                    e.printStackTrace();
                }
...
//            Toast.makeText(getContext(), R.string.msg_no_internet,
//                    Toast.LENGTH_SHORT).show();
            Log.e("place", "Error getting autocomplete prediction API call", e);
            return null;
        }
    }
}
